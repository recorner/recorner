...
class HomeController
{
    public function index()
    {
        ...
        $settings7 = [
            'chart_title'           => 'Supporter Registartions',
            'chart_type'            => 'line',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Supporter',
            'group_by_field'        => 'created_at',
        ...
        $settings8 = [
            'chart_title'           => 'weekly expendatures',
            'chart_type'            => 'pie',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Expense',
            'group_by_field'        => 'entry_date',
        ...
        return view('home', compact('settings1', 'settings2', 'settings3', 'settings4', 'settings5', 'settings6', 'chart7', 'chart8'));
    }
}
