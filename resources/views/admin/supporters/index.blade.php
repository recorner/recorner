...
@can('supporter_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Supporter', 'route' => 'admin.supporters.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.supporter.title_singular') }} {{ trans('global.list') }}
    </div>
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Supporter').DataTable(dtOverrideGlobals);
